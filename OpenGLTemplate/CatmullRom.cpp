...
void CCatmullRom::SetControlPoints()
{
	...
	m_controlPoints.push_back(glm::vec3(0, 2.f, 200));
	m_controlPoints.push_back(glm::vec3(0, 10.f, 0));
	m_controlPoints.push_back(glm::vec3(0, 20.f, -200));
	m_controlPoints.push_back(glm::vec3(100, 30.f, -200));
	m_controlPoints.push_back(glm::vec3(100, 40.f, -500));
	m_controlPoints.push_back(glm::vec3(600, 20.f, -650));
	m_controlPoints.push_back(glm::vec3(900, 10.f, -750));
	m_controlPoints.push_back(glm::vec3(800, 5.f, -500));
	m_controlPoints.push_back(glm::vec3(650, 2.f, -350));
}
